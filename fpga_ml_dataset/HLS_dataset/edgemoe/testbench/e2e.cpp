...
int main(int argc, char* argv[])
{
    ...
    {
        string filename = "testbench/image.float32.bin";
    ...
    {
        string filename = "testbench/patch_embed_weight.float32.bin";
        ifstream ifs(filename, std::ios::binary);
    ...
    {
        string filename = "testbench/patch_embed_bias.float32.bin";
        ifstream ifs(filename, std::ios::binary);
    ...
    {
        string filename = "testbench/pos_embed.float32.bin";
        ifstream ifs(filename, std::ios::binary);
        read(ifs, pos_embed);
        if (!ifs)
        {
    ...
    {
        ostringstream oss;
        oss << "testbench/l" << layer << "_qkv_weight.float32.bin";
    ...
    {
        ostringstream oss;
        oss << "testbench/l" << layer << "_attn_proj_weight.float32.bin";
        string filename = oss.str();
        ifstream ifs(filename, std::ios::binary);
    ...
    {
        ostringstream oss;
        oss << "testbench/l" << layer << "_qkv_bias.float32.bin";
        string filename = oss.str();
        ifstream ifs(filename, std::ios::binary);
    ...
    {
        ostringstream oss;
        oss << "testbench/l" << layer << "_attn_proj_bias.float32.bin";
        string filename = oss.str();
        ifstream ifs(filename, std::ios::binary);
    ...
    {
        ostringstream oss;
        oss << "testbench/l" << (moe_layer * 2 + 1) << "_w_gate_T_task0.float32.bin";
        string filename = oss.str();
        ifstream ifs(filename, std::ios::binary);
    ...
    {
        ostringstream oss;
        oss << "testbench/l" << (moe_layer * 2 + 1) << "_htoh4_weight.float32.bin";
        string filename = oss.str();
        ifstream ifs(filename, std::ios::binary);
    ...
    {
        ostringstream oss;
        oss << "testbench/l" << (moe_layer * 2 + 1) << "_htoh4_bias.float32.bin";
        string filename = oss.str();
        ifstream ifs(filename, std::ios::binary);
    ...
    {
        ostringstream oss;
        oss << "testbench/l" << (moe_layer * 2 + 1) << "_h4toh_weight.float32.bin";
        string filename = oss.str();
        ifstream ifs(filename, std::ios::binary);
    ...
    {
        ostringstream oss;
        oss << "testbench/l" << (moe_layer * 2 + 1) << "_h4toh_bias.float32.bin";
        string filename = oss.str();
        ifstream ifs(filename, std::ios::binary);
    ...
    {
        ostringstream oss;
        oss << "testbench/l" << (vit_layer * 2) << "_fc1_weight.float32.bin";
        string filename = oss.str();
        ifstream ifs(filename, std::ios::binary);
    ...
    {
        ostringstream oss;
        oss << "testbench/l" << (vit_layer * 2) << "_fc1_bias.float32.bin";
        string filename = oss.str();
        ifstream ifs(filename, std::ios::binary);
    ...
    {
        ostringstream oss;
        oss << "testbench/l" << (vit_layer * 2) << "_fc2_weight.float32.bin";
        string filename = oss.str();
        ifstream ifs(filename, std::ios::binary);
    ...
    {
        ostringstream oss;
        oss << "testbench/l" << (vit_layer * 2) << "_fc2_bias.float32.bin";
        string filename = oss.str();
        ifstream ifs(filename, std::ios::binary);
    ...
    {
        ostringstream oss;
        oss << "testbench/l" << layer << "_norm1_weight.float32.bin";
        string filename = oss.str();
        ifstream ifs(filename, std::ios::binary);
    ...
    {
        ostringstream oss;
        oss << "testbench/l" << layer << "_norm2_weight.float32.bin";
        string filename = oss.str();
        ifstream ifs(filename, std::ios::binary);
    ...
    {
        ostringstream oss;
        oss << "testbench/l" << layer << "_norm1_bias.float32.bin";
        string filename = oss.str();
        ifstream ifs(filename, std::ios::binary);
    ...
    {
        ostringstream oss;
        oss << "testbench/l" << layer << "_norm2_bias.float32.bin";
        string filename = oss.str();
        ifstream ifs(filename, std::ios::binary);
    ...
    {
        ostringstream oss;
        oss << "testbench/" << reference_var_name << ".float32.bin";
        string filename = oss.str();
        ifstream ifs(filename, std::ios::binary);
