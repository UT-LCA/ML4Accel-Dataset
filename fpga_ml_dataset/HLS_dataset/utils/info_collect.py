...
def run_routine(prj_list, prj_dir):
    ...
    for prj_name in prj_list:
        if os.path.exists(
            "{}/{}/power.xls".format(prj_dir, prj_name)
        ) and os.path.exists("{}/{}/utilization.xls".format(prj_dir, prj_name)):
    ...
    with open(file_path, "w+", newline="") as f:
        ...
        for prj in vpower_dic:
            wr_line = [prj] + [vpower_dic[prj]] + utilization_dic[prj]
