...
set_directive_array_partition -type [type] -factor [factor] -dim 1 "k3mm" buff_A
set_directive_array_partition -type [type] -factor [factor] -dim 1 "k3mm" buff_B
set_directive_array_partition -type [type] -factor [factor] -dim 1 "k3mm" buff_C
set_directive_array_partition -type [type] -factor [factor] -dim 1 "k3mm" buff_D
set_directive_array_partition -type [type] -factor [factor] -dim 1 "k3mm" buff_E_out
set_directive_array_partition -type [type] -factor [factor] -dim 1 "k3mm" tmp1
set_directive_array_partition -type [type] -factor [factor] -dim 1 "k3mm" tmp2
