...
set_directive_array_partition -type [type] -factor [factor] -dim 1 "gemm" buff_A
set_directive_array_partition -type [type] -factor [factor] -dim 1 "gemm" buff_B
set_directive_array_partition -type [type] -factor [factor] -dim 1 "gemm" buff_C
set_directive_array_partition -type [type] -factor [factor] -dim 1 "gemm" buff_D_out
set_directive_array_partition -type [type] -factor [factor] -dim 1 "gemm" tmp1
