...
#dim = 4, for iob
array_partition,12,[1 2 4 8],[cyclic]
...
set_directive_array_partition -type [type] -factor [factor] -dim 1 "gesummv" buff_A
set_directive_array_partition -type [type] -factor [factor] -dim 1 "gesummv" buff_B
