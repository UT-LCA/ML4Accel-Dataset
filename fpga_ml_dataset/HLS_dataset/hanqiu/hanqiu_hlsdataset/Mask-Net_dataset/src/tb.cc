...
//float dw3_mask[192][40][80];
float dw4__conv_3x3_mask[192][20][40];
float dw4__conv_1x1_mask[384][20][40];
float dw5__conv_3x3_mask[384][20][40];
float dw5__conv_1x1_mask[512][20][40];
float dw6_conv_3x3_mask[1280][20][40];
float dw6_conv_1x1_mask[96][20][40];

//define the new branch 
//float new_branch_conv_5x5_max_pool_output[192][40][40];
float new_branch_conv_5x5_weight[32][6][5][5];
float new_branch_conv_5x5_bias[32];
float new_branch_conv_5x5_output[32][20][40];
//float new_branch_conv_3x3_max_pool_output[32][4][8];
float new_branch_conv_3x3_max_pool_output1[32][10][20];
float new_branch_conv_3x3_max_pool_output2[32][5][10];
float new_branch_conv_3x3_max_pool_output3[32][5][5];
float new_branch_conv_3x3_weight[1][32][3][3];
float mask_temp[1][5][5];
//float mask[1][5][5];
...
//define the new branch
//float new_branch_conv_5x5_weight[16][192][5][5];
//float new_branch_conv_5x5_bias[16];
//float new_branch_conv_3x3_weight[1][16][3][3];
...
uint16 fix_conv_weight_5x5_all_16[32][6][5][5];
...
uint512 fix_conv_weight_5x5_all_512bit[6][5][5];
...
//uint512 DDR_buf_burst_new_branch1[6 * 48 * 88];
uint512 DDR_buf_burst_new_branch2[44*84];
...
void load_weights()
{
	std::ifstream ifs_param("skynet_DAC.bin", std::ios::in | std::ios::binary);
	///////////// Read Weights ///////////////////////
	...
	ifs_param.read((char*)(***new_branch_conv_5x5_weight), 32 * 6 * 5 * 5 * sizeof(float));
	ifs_param.read((char*)(new_branch_conv_5x5_bias), 32 * sizeof(float));
	ifs_param.read((char*)(***new_branch_conv_3x3_weight), 1 * 32 * 3 * 3 * sizeof(float));
	ifs_param.close();
}
...
int test_one_group(char* img0, char* img1, char* img2 , char* img3, char* img_g)
{
 ...
 //   ///////////// Prepare Image //////////////////////
	...
	MaskNet(image_raw_g_burst,
			...
			DDR_buf_burst,
		    //DDR_buf_burst_new_branch1,
		    //DDR_buf_burst_new_branch2,
