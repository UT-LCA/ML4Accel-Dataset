...
float gnn_convs_0_mlp_linear_0_weight_in[64][11];
float gnn_convs_0_mlp_linear_0_bias_in[64];
float gnn_convs_0_mlp_linear_1_weight_in[128][64];
float gnn_convs_0_mlp_linear_1_bias_in[128];
float gnn_convs_1_mlp_linear_0_weight_in[64][128];
float gnn_convs_1_mlp_linear_0_bias_in[64];
float gnn_convs_1_mlp_linear_1_weight_in[128][64];
float gnn_convs_1_mlp_linear_1_bias_in[128];
float gnn_convs_2_mlp_linear_0_weight_in[64][128];
float gnn_convs_2_mlp_linear_0_bias_in[64];
float gnn_convs_2_mlp_linear_1_weight_in[128][64];
float gnn_convs_2_mlp_linear_1_bias_in[128];
float gnn_convs_3_mlp_linear_0_weight_in[64][128];
float gnn_convs_3_mlp_linear_0_bias_in[64];
float gnn_convs_3_mlp_linear_1_weight_in[128][64];
float gnn_convs_3_mlp_linear_1_bias_in[128];
float gnn_convs_4_mlp_linear_0_weight_in[64][128];
float gnn_convs_4_mlp_linear_0_bias_in[64];
float gnn_convs_4_mlp_linear_1_weight_in[128][64];
float gnn_convs_4_mlp_linear_1_bias_in[128];
float gnn_convs_5_mlp_linear_0_weight_in[64][128];
float gnn_convs_5_mlp_linear_0_bias_in[64];
float gnn_convs_5_mlp_linear_1_weight_in[64][64];
float gnn_convs_5_mlp_linear_1_bias_in[64];
...
void load_tb_parameters(){
    ...
    load_data_2d<64, 11>("./tb_data/model_parameters/gnn_convs_0_mlp_linear_0_weight.bin", gnn_convs_0_mlp_linear_0_weight_in);
    load_data_1d<64>("./tb_data/model_parameters/gnn_convs_0_mlp_linear_0_bias.bin", gnn_convs_0_mlp_linear_0_bias_in);
    load_data_2d<128, 64>("./tb_data/model_parameters/gnn_convs_0_mlp_linear_1_weight.bin", gnn_convs_0_mlp_linear_1_weight_in);
    load_data_1d<128>("./tb_data/model_parameters/gnn_convs_0_mlp_linear_1_bias.bin", gnn_convs_0_mlp_linear_1_bias_in);
    load_data_2d<64, 128>("./tb_data/model_parameters/gnn_convs_1_mlp_linear_0_weight.bin", gnn_convs_1_mlp_linear_0_weight_in);
    load_data_1d<64>("./tb_data/model_parameters/gnn_convs_1_mlp_linear_0_bias.bin", gnn_convs_1_mlp_linear_0_bias_in);
    load_data_2d<128, 64>("./tb_data/model_parameters/gnn_convs_1_mlp_linear_1_weight.bin", gnn_convs_1_mlp_linear_1_weight_in);
    load_data_1d<128>("./tb_data/model_parameters/gnn_convs_1_mlp_linear_1_bias.bin", gnn_convs_1_mlp_linear_1_bias_in);
    load_data_2d<64, 128>("./tb_data/model_parameters/gnn_convs_2_mlp_linear_0_weight.bin", gnn_convs_2_mlp_linear_0_weight_in);
    load_data_1d<64>("./tb_data/model_parameters/gnn_convs_2_mlp_linear_0_bias.bin", gnn_convs_2_mlp_linear_0_bias_in);
    load_data_2d<128, 64>("./tb_data/model_parameters/gnn_convs_2_mlp_linear_1_weight.bin", gnn_convs_2_mlp_linear_1_weight_in);
    load_data_1d<128>("./tb_data/model_parameters/gnn_convs_2_mlp_linear_1_bias.bin", gnn_convs_2_mlp_linear_1_bias_in);
    load_data_2d<64, 128>("./tb_data/model_parameters/gnn_convs_3_mlp_linear_0_weight.bin", gnn_convs_3_mlp_linear_0_weight_in);
    load_data_1d<64>("./tb_data/model_parameters/gnn_convs_3_mlp_linear_0_bias.bin", gnn_convs_3_mlp_linear_0_bias_in);
    load_data_2d<128, 64>("./tb_data/model_parameters/gnn_convs_3_mlp_linear_1_weight.bin", gnn_convs_3_mlp_linear_1_weight_in);
    load_data_1d<128>("./tb_data/model_parameters/gnn_convs_3_mlp_linear_1_bias.bin", gnn_convs_3_mlp_linear_1_bias_in);
    load_data_2d<64, 128>("./tb_data/model_parameters/gnn_convs_4_mlp_linear_0_weight.bin", gnn_convs_4_mlp_linear_0_weight_in);
    load_data_1d<64>("./tb_data/model_parameters/gnn_convs_4_mlp_linear_0_bias.bin", gnn_convs_4_mlp_linear_0_bias_in);
    load_data_2d<128, 64>("./tb_data/model_parameters/gnn_convs_4_mlp_linear_1_weight.bin", gnn_convs_4_mlp_linear_1_weight_in);
    load_data_1d<128>("./tb_data/model_parameters/gnn_convs_4_mlp_linear_1_bias.bin", gnn_convs_4_mlp_linear_1_bias_in);
    load_data_2d<64, 128>("./tb_data/model_parameters/gnn_convs_5_mlp_linear_0_weight.bin", gnn_convs_5_mlp_linear_0_weight_in);
    load_data_1d<64>("./tb_data/model_parameters/gnn_convs_5_mlp_linear_0_bias.bin", gnn_convs_5_mlp_linear_0_bias_in);
    load_data_2d<64, 64>("./tb_data/model_parameters/gnn_convs_5_mlp_linear_1_weight.bin", gnn_convs_5_mlp_linear_1_weight_in);
    load_data_1d<64>("./tb_data/model_parameters/gnn_convs_5_mlp_linear_1_bias.bin", gnn_convs_5_mlp_linear_1_bias_in);
    ...
    cast_2d<64, 11, float, W_TYPE>(gnn_convs_0_mlp_linear_0_weight_in, gnn_convs_0_mlp_linear_0_weight_fixed_in);
    cast_1d<64, float, W_TYPE>(gnn_convs_0_mlp_linear_0_bias_in, gnn_convs_0_mlp_linear_0_bias_fixed_in);
    cast_2d<128, 64, float, W_TYPE>(gnn_convs_0_mlp_linear_1_weight_in, gnn_convs_0_mlp_linear_1_weight_fixed_in);
    cast_1d<128, float, W_TYPE>(gnn_convs_0_mlp_linear_1_bias_in, gnn_convs_0_mlp_linear_1_bias_fixed_in);
    cast_2d<64, 128, float, W_TYPE>(gnn_convs_1_mlp_linear_0_weight_in, gnn_convs_1_mlp_linear_0_weight_fixed_in);
    cast_1d<64, float, W_TYPE>(gnn_convs_1_mlp_linear_0_bias_in, gnn_convs_1_mlp_linear_0_bias_fixed_in);
    cast_2d<128, 64, float, W_TYPE>(gnn_convs_1_mlp_linear_1_weight_in, gnn_convs_1_mlp_linear_1_weight_fixed_in);
    cast_1d<128, float, W_TYPE>(gnn_convs_1_mlp_linear_1_bias_in, gnn_convs_1_mlp_linear_1_bias_fixed_in);
    cast_2d<64, 128, float, W_TYPE>(gnn_convs_2_mlp_linear_0_weight_in, gnn_convs_2_mlp_linear_0_weight_fixed_in);
    cast_1d<64, float, W_TYPE>(gnn_convs_2_mlp_linear_0_bias_in, gnn_convs_2_mlp_linear_0_bias_fixed_in);
    cast_2d<128, 64, float, W_TYPE>(gnn_convs_2_mlp_linear_1_weight_in, gnn_convs_2_mlp_linear_1_weight_fixed_in);
    cast_1d<128, float, W_TYPE>(gnn_convs_2_mlp_linear_1_bias_in, gnn_convs_2_mlp_linear_1_bias_fixed_in);
    cast_2d<64, 128, float, W_TYPE>(gnn_convs_3_mlp_linear_0_weight_in, gnn_convs_3_mlp_linear_0_weight_fixed_in);
    cast_1d<64, float, W_TYPE>(gnn_convs_3_mlp_linear_0_bias_in, gnn_convs_3_mlp_linear_0_bias_fixed_in);
    cast_2d<128, 64, float, W_TYPE>(gnn_convs_3_mlp_linear_1_weight_in, gnn_convs_3_mlp_linear_1_weight_fixed_in);
    cast_1d<128, float, W_TYPE>(gnn_convs_3_mlp_linear_1_bias_in, gnn_convs_3_mlp_linear_1_bias_fixed_in);
    cast_2d<64, 128, float, W_TYPE>(gnn_convs_4_mlp_linear_0_weight_in, gnn_convs_4_mlp_linear_0_weight_fixed_in);
    cast_1d<64, float, W_TYPE>(gnn_convs_4_mlp_linear_0_bias_in, gnn_convs_4_mlp_linear_0_bias_fixed_in);
    cast_2d<128, 64, float, W_TYPE>(gnn_convs_4_mlp_linear_1_weight_in, gnn_convs_4_mlp_linear_1_weight_fixed_in);
    cast_1d<128, float, W_TYPE>(gnn_convs_4_mlp_linear_1_bias_in, gnn_convs_4_mlp_linear_1_bias_fixed_in);
    cast_2d<64, 128, float, W_TYPE>(gnn_convs_5_mlp_linear_0_weight_in, gnn_convs_5_mlp_linear_0_weight_fixed_in);
    cast_1d<64, float, W_TYPE>(gnn_convs_5_mlp_linear_0_bias_in, gnn_convs_5_mlp_linear_0_bias_fixed_in);
    cast_2d<64, 64, float, W_TYPE>(gnn_convs_5_mlp_linear_1_weight_in, gnn_convs_5_mlp_linear_1_weight_fixed_in);
    cast_1d<64, float, W_TYPE>(gnn_convs_5_mlp_linear_1_bias_in, gnn_convs_5_mlp_linear_1_bias_fixed_in);
