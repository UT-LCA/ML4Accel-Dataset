...
float gnn_convs_0_conv_lin_l_weight_in[128][11];
float gnn_convs_0_conv_lin_l_bias_in[128];
float gnn_convs_0_conv_lin_r_weight_in[128][11];
float gnn_convs_1_conv_lin_l_weight_in[128][128];
float gnn_convs_1_conv_lin_l_bias_in[128];
float gnn_convs_1_conv_lin_r_weight_in[128][128];
float gnn_convs_2_conv_lin_l_weight_in[128][128];
float gnn_convs_2_conv_lin_l_bias_in[128];
float gnn_convs_2_conv_lin_r_weight_in[128][128];
float gnn_convs_3_conv_lin_l_weight_in[128][128];
float gnn_convs_3_conv_lin_l_bias_in[128];
float gnn_convs_3_conv_lin_r_weight_in[128][128];
float gnn_convs_4_conv_lin_l_weight_in[128][128];
float gnn_convs_4_conv_lin_l_bias_in[128];
float gnn_convs_4_conv_lin_r_weight_in[128][128];
float gnn_convs_5_conv_lin_l_weight_in[64][128];
float gnn_convs_5_conv_lin_l_bias_in[64];
float gnn_convs_5_conv_lin_r_weight_in[64][128];
...
void load_tb_parameters(){
    ...
    load_data_2d<128, 11>("./tb_data/model_parameters/gnn_convs_0_conv_lin_l_weight.bin", gnn_convs_0_conv_lin_l_weight_in);
    load_data_1d<128>("./tb_data/model_parameters/gnn_convs_0_conv_lin_l_bias.bin", gnn_convs_0_conv_lin_l_bias_in);
    load_data_2d<128, 11>("./tb_data/model_parameters/gnn_convs_0_conv_lin_r_weight.bin", gnn_convs_0_conv_lin_r_weight_in);
    load_data_2d<128, 128>("./tb_data/model_parameters/gnn_convs_1_conv_lin_l_weight.bin", gnn_convs_1_conv_lin_l_weight_in);
    load_data_1d<128>("./tb_data/model_parameters/gnn_convs_1_conv_lin_l_bias.bin", gnn_convs_1_conv_lin_l_bias_in);
    load_data_2d<128, 128>("./tb_data/model_parameters/gnn_convs_1_conv_lin_r_weight.bin", gnn_convs_1_conv_lin_r_weight_in);
    load_data_2d<128, 128>("./tb_data/model_parameters/gnn_convs_2_conv_lin_l_weight.bin", gnn_convs_2_conv_lin_l_weight_in);
    load_data_1d<128>("./tb_data/model_parameters/gnn_convs_2_conv_lin_l_bias.bin", gnn_convs_2_conv_lin_l_bias_in);
    load_data_2d<128, 128>("./tb_data/model_parameters/gnn_convs_2_conv_lin_r_weight.bin", gnn_convs_2_conv_lin_r_weight_in);
    load_data_2d<128, 128>("./tb_data/model_parameters/gnn_convs_3_conv_lin_l_weight.bin", gnn_convs_3_conv_lin_l_weight_in);
    load_data_1d<128>("./tb_data/model_parameters/gnn_convs_3_conv_lin_l_bias.bin", gnn_convs_3_conv_lin_l_bias_in);
    load_data_2d<128, 128>("./tb_data/model_parameters/gnn_convs_3_conv_lin_r_weight.bin", gnn_convs_3_conv_lin_r_weight_in);
    load_data_2d<128, 128>("./tb_data/model_parameters/gnn_convs_4_conv_lin_l_weight.bin", gnn_convs_4_conv_lin_l_weight_in);
    load_data_1d<128>("./tb_data/model_parameters/gnn_convs_4_conv_lin_l_bias.bin", gnn_convs_4_conv_lin_l_bias_in);
    load_data_2d<128, 128>("./tb_data/model_parameters/gnn_convs_4_conv_lin_r_weight.bin", gnn_convs_4_conv_lin_r_weight_in);
    load_data_2d<64, 128>("./tb_data/model_parameters/gnn_convs_5_conv_lin_l_weight.bin", gnn_convs_5_conv_lin_l_weight_in);
    load_data_1d<64>("./tb_data/model_parameters/gnn_convs_5_conv_lin_l_bias.bin", gnn_convs_5_conv_lin_l_bias_in);
    load_data_2d<64, 128>("./tb_data/model_parameters/gnn_convs_5_conv_lin_r_weight.bin", gnn_convs_5_conv_lin_r_weight_in);
    ...
    cast_2d<128, 11, float, W_TYPE>(gnn_convs_0_conv_lin_l_weight_in, gnn_convs_0_conv_lin_l_weight_fixed_in);
    cast_1d<128, float, W_TYPE>(gnn_convs_0_conv_lin_l_bias_in, gnn_convs_0_conv_lin_l_bias_fixed_in);
    cast_2d<128, 11, float, W_TYPE>(gnn_convs_0_conv_lin_r_weight_in, gnn_convs_0_conv_lin_r_weight_fixed_in);
    cast_2d<128, 128, float, W_TYPE>(gnn_convs_1_conv_lin_l_weight_in, gnn_convs_1_conv_lin_l_weight_fixed_in);
    cast_1d<128, float, W_TYPE>(gnn_convs_1_conv_lin_l_bias_in, gnn_convs_1_conv_lin_l_bias_fixed_in);
    cast_2d<128, 128, float, W_TYPE>(gnn_convs_1_conv_lin_r_weight_in, gnn_convs_1_conv_lin_r_weight_fixed_in);
    cast_2d<128, 128, float, W_TYPE>(gnn_convs_2_conv_lin_l_weight_in, gnn_convs_2_conv_lin_l_weight_fixed_in);
    cast_1d<128, float, W_TYPE>(gnn_convs_2_conv_lin_l_bias_in, gnn_convs_2_conv_lin_l_bias_fixed_in);
    cast_2d<128, 128, float, W_TYPE>(gnn_convs_2_conv_lin_r_weight_in, gnn_convs_2_conv_lin_r_weight_fixed_in);
    cast_2d<128, 128, float, W_TYPE>(gnn_convs_3_conv_lin_l_weight_in, gnn_convs_3_conv_lin_l_weight_fixed_in);
    cast_1d<128, float, W_TYPE>(gnn_convs_3_conv_lin_l_bias_in, gnn_convs_3_conv_lin_l_bias_fixed_in);
    cast_2d<128, 128, float, W_TYPE>(gnn_convs_3_conv_lin_r_weight_in, gnn_convs_3_conv_lin_r_weight_fixed_in);
    cast_2d<128, 128, float, W_TYPE>(gnn_convs_4_conv_lin_l_weight_in, gnn_convs_4_conv_lin_l_weight_fixed_in);
    cast_1d<128, float, W_TYPE>(gnn_convs_4_conv_lin_l_bias_in, gnn_convs_4_conv_lin_l_bias_fixed_in);
    cast_2d<128, 128, float, W_TYPE>(gnn_convs_4_conv_lin_r_weight_in, gnn_convs_4_conv_lin_r_weight_fixed_in);
    cast_2d<64, 128, float, W_TYPE>(gnn_convs_5_conv_lin_l_weight_in, gnn_convs_5_conv_lin_l_weight_fixed_in);
    cast_1d<64, float, W_TYPE>(gnn_convs_5_conv_lin_l_bias_in, gnn_convs_5_conv_lin_l_bias_fixed_in);
    cast_2d<64, 128, float, W_TYPE>(gnn_convs_5_conv_lin_r_weight_in, gnn_convs_5_conv_lin_r_weight_fixed_in);
